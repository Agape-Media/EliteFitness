              ...
              <div className="w-full lg:w-6/12 px-4 ml-auto mr-auto text-center">
                <div>
                  <h1 className="text-white font-semibold text-5xl">
                    Welcome to <span className="text-red-700">Elite</span>{" "}
                    Fitness
                  </h1>
                  <p className="mx-auto w-2/3 mt-4 text-lg text-gray-300">
                    We are a fitness and training facility that focuses on
              ...
              >
                <div className="md:pr-12 ">
                  ...
                  <p className="mt-4 text-lg leading-relaxed">
                    Elite Fitness is a 24/7 workout facility offering commercial
                    equipment, warehouse-style lifting and cross-training to
                    cater to different workout styles and help you create a
            ...
            <div className="flex flex-wrap justify-center text-center mb-24">
              <div className="w-full lg:w-6/12 px-4">
                ...
                <p className="text-lg leading-relaxed m-4">
                  Our three workout sections designed to help get you in the
